...
export const stories: Story[] = [
  {
    ...
    status: "POPULAR",
    summary:
      "A gentle tale about the moon singing bedtime songs to all the children of the world.",
    pages: [
  ...
  },
  {
    ...
    status: "NEW",
    summary:
      "Journey to a magical village built on clouds where everything is soft and peaceful.",
    pages: [
  ...
  },
  {
    ...
    status: "NEW",
    summary:
      "A gentle giant collects falling stars and returns them to the sky.",
    text: [
  ...
  },
  {
    ...
    status: "POPULAR",
    summary:
      "A rabbit family prepares their underground home for the perfect sleep.",
    text: [
  ...
  },
  {
    ...
    status: "DOWNLOADED",
    summary:
      "Cross a magical rainbow bridge into the land of beautiful dreams.",
    text: [
...
export const downloadedStories = stories.filter(
