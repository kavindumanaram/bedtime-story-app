...
const interactiveThemes = [
  {
    label: "Brave Knight",
    theme: "a brave knight facing three bold choices",
    emoji: "⚔️",
  },
  {
    label: "Enchanted Forest",
    theme: "magical forest with hidden paths to explore",
    emoji: "🌿",
  },
  {
    label: "Space Explorer",
    theme: "space explorer discovering unknown worlds",
    emoji: "🚀",
  },
  {
    label: "Dragon Keeper",
    theme: "befriending a young dragon with surprising decisions",
    emoji: "🐉",
  },
  {
    label: "Ocean Mystery",
    theme: "underwater adventure with brave choices",
    emoji: "🌊",
  },
  {
    label: "Fairy Kingdom",
    theme: "fairy kingdom with magical crossroads",
    emoji: "🧚",
  },
];
...
export const Create: React.FC = () => {
  ...
  useEffect(() => {
    ...
    getMemoryContext(activeChild.id)
      .then(setMemory)
      .catch(() => null);
    getTopCharacters(activeChild.id, 5)
      .then(setCharacters)
      .catch(() => null);
  }, [activeChild]);
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const saved: GeneratedStory = {
        ...
        characterContext:
          extractedChars.length > 0 ? extractedChars : undefined,
        ...
        <div className="relative z-10 p-7 pb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span
              ...
              style={{ color: "rgba(245,183,49,0.8)" }}
            >
              Story Studio
            </span>
          </div>
          ...
          <p style={{ color: "rgba(255,255,255,0.45)", fontSize: 13 }}>
            Generate a personalised bedtime adventure for{" "}
          ...
          <div className="p-6 lg:p-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {(
                  ["new", "narrative", "continue", "character"] as StoryMode[]
                ).map((mode) => {
            ...
            {activeChild ? (
              ...
              >
                <span
                  className="w-10 h-10 rounded-full flex items-center justify-center text-white font-black text-sm flex-shrink-0 shadow-md"
            ...
            {storyMode === "continue" &&
              (memory ? (
                ...
                >
                  No previous story found. Read a story first to unlock
                  continuation.
                </div>
              ))}
              ...
              <div className="space-y-2">
                ...
                {characters.length > 0 ? (
                  ...
                  <p className="text-xs" style={{ color: "#9CA3AF" }}>
                    Characters appear here after children read stories with
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onBlur={(e) => {
                    ...
                    e.currentTarget.style.background = "#F4F3F9";
                  }}
                />
              </div>
            )}
            ...
            {error && (
              <div
                className="flex items-start gap-2 text-sm px-4 py-3 rounded-2xl"
                style={{
                  color: "#dc2626",
            ...
            <button
              ...
              disabled={
                !activeChild ||
                (storyMode === "continue" && (!profile || !memory))
              }
